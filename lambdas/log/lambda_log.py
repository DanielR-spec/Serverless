...
def lambda_handler(event, context):
    ...
    # Review request type and return acording response
        ...
        # Construct the SQL statement to insert data into the Redshift table
            insert_sql = f"INSERT INTO {table} (user_id,user_email,first_name,last_name,organization_id,organization_name,request_type,request_path,request_timestamp,response_timestamp,duration,response_status,device_type,country_id,time_zone,error) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
